...
namespace Tac.StickyControls
{
    ...
    public class StickyControls : MonoBehaviour
    {
        ...
        internal const string MODID = "TacStickyControls_NS";
        internal const string MODNAME = "TAC Sticky Controls";
        ...
        private void OnGUIAppLauncherReady()
        {
            ...
            toolbarControl.AddToAllToolbars(ToggleToolbarButton, ToggleToolbarButton,
                ...
                MODID,
                "tacStikyControlsButton",
                "TacStickyControls/Images/TacStickyControlsOn-38",
                "TacStickyControls/Images/TacStickyControlsOff-38",
                "TacStickyControls/Images/TacStickyControlsOn-24",
                "TacStickyControls/Images/TacStickyControlsOff-24",
                MODNAME
            );
